# Form implementation generated from reading ui file 'layout_text_without_color.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_GW_TimeInterval.setStyleSheet("")
        ...
        self.label_8.setStyleSheet("QLabel:disabled {\n"
...
"}")
        ...
        self.label_17.setStyleSheet("QLabel:disabled {\n"
"    color: #A0A0A0;  /* Grey color when disabled */\n"
"}")
        ...
        self.label_18.setStyleSheet("QLabel:disabled {\n"
"    color: #A0A0A0;  /* Grey color when disabled */\n"
"}")
        ...
        self.label_14.setStyleSheet("QLabel:disabled {\n"
"    color: #A0A0A0;  /* Grey color when disabled */\n"
"}")
        ...
        self.label_31.setToolTip("<html><head/><body><p><span style=\"font-size: 15px;\">Displays tips, warnings and status update messages.</span></p></body></html>")
        ...
        self.menuAbout.setGeometry(QtCore.QRect(3003, 136, 159, 81))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
...
"            }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.helpButton1.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">Displays help contents for the \"Get Data\" tab.</span></p></body></html>"))
        self.helpButton1.setText(_translate("MainWindow", "Help"))
        self.label.setText(_translate("MainWindow", "<html><head/><body><p>Select a Detector</p></body></html>"))
        ...
        self.label_2.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">GPS time: seconds elapsed since reference date of 6th January 1980.</span></p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "Starting time (GPS)"))
        self.label_3.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">GPS time: seconds elapsed since reference date of 6th January 1980.</span></p></body></html>"))
        ...
        self.comboBox_3.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">Select a known glitch for the LIGO-Hanford detector. Note that the examples provided currently are for the specific detector only.</span></p></body></html>"))
        ...
        self.label_30.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">Displays tips, warnings and status update messages.</span></p></body></html>"))
        ...
        self.tabWidget.setTabToolTip(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">First select a detector and then click on one of the 3 checkboxes to download some data.</span></p></body></html>"))
        self.helpButton2.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">Displays help contents for the \"Plot Data\" tab.</span></p></body></html>"))
        self.helpButton2.setText(_translate("MainWindow", "Help"))
        self.label_25.setText(_translate("MainWindow", "<html><head/><body><p>Plot settings</p></body></html>"))
        self.checkBox_5.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">Whitening is a process to remove noise from GW data.</span></p></body></html>"))
        self.checkBox_5.setText(_translate("MainWindow", "Whiten the data"))
        self.label_9.setText(_translate("MainWindow", "<html><head/><body><p>A band pass filter will be applied unless the &quot;No freq selection&quot; is clicked</p></body></html>"))
        ...
        self.label_10.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">A time-frequency representation based on the Q-transform.</span></p></body></html>"))
        self.label_10.setText(_translate("MainWindow", "<html><head/><body><p>Q scan section</p></body></html>"))
        self.label_19.setText(_translate("MainWindow", "<html><head/><body><p>Additional plot settings for Q scan plot</p></body></html>"))
        ...
        self.tabWidget.setTabToolTip(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">After having downloaded some data, click on \'Plot strain\' and \'Plot Qscan\' to visualize them.</span></p></body></html>"))
        self.helpButton3.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">Displays help contents for the \"Explore GW event parameters\" tab.</span></p></body></html>"))
        self.helpButton3.setText(_translate("MainWindow", "Help"))
        self.label_38.setText(_translate("MainWindow", "<html><head/><body><p>Event parameters</p></body></html>"))
        self.label_39.setText(_translate("MainWindow", "<html><head/><body><p>Select an event from the list</p></body></html>"))
        self.comboBox_4.setItemText(0, _translate("MainWindow", "None"))
        self.label_40.setText(_translate("MainWindow", "<html><head/><body><p>Or write the name of the event below</p></body></html>"))
        self.pushButton_9.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">Downloads the selected event\'s parameters and displays them in the log window.</span></p></body></html>"))
        self.pushButton_9.setText(_translate("MainWindow", "Get event parameters"))
        self.pushButton_13.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">Downloads, saves and displays the selected event\'s skymap (sky localization).</span></p></body></html>"))
        self.pushButton_13.setText(_translate("MainWindow", "Download skymap"))
        self.label_44.setText(_translate("MainWindow", "<html><head/><body><p>Plotting options for both plots</p></body></html>"))
        self.checkBox_2.setText(_translate("MainWindow", "Highlight current event"))
        self.label_41.setText(_translate("MainWindow", "<html><head/><body><p>Parameters distributions</p></body></html>"))
        self.label_42.setText(_translate("MainWindow", "<html><head/><body><p>Select a parameter from the list to plot a histogram of all events</p></body></html>"))
        ...
        self.label_43.setText(_translate("MainWindow", "<html><head/><body><p>Select another parameter from the list to create a 2D scatter plot of all events</p></body></html>"))
        ...
        self.label_34.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">Displays tips, warnings and status update messages.</span></p></body></html>"))
        ...
        self.tabWidget.setTabToolTip(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "<html><head/><body><p><span style=\"font-size: 15px;\">Download skymaps of GW events and analyze parameter distributions with histograms and scatter plots.</span></p></body></html>"))
